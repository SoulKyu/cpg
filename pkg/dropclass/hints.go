...
// Only entries pointing at an actionable topic page or an anchored ("#...") URL are
// included; the bare troubleshooting page is omitted (M1: empty hint is surfaced as
// "" by RemediationHint, suppressing the "Hint:" line in the cluster-health summary
// and the remediation field in the JSON).
//
// Entries to KEEP:
//
//	Anchored deep links: CT_MAP_INSERTION_FAILED, SERVICE_BACKEND_NOT_FOUND,
//	FIB_LOOKUP_FAILED.
//	Actionable topic pages (no anchor): UNENCRYPTED_TRAFFIC, NO_EGRESS_GATEWAY,
//	DROP_NO_EGRESS_IP.
//
